 ...
 * @property int $id
 * @property string $name
 * @property \Illuminate\Database\Eloquent\Collection|\Model|null|static|static[] $food_items
 * @property int $dining_center_id
 * @property \Carbon\Carbon $start
 * @property \Carbon\Carbon $end
 * @property \Carbon\Carbon|null $created_at
 * @property \Carbon\Carbon|null $updated_at
 * @property-read \App\DiningCenter $diningCenter
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Menu whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Menu whereDiningCenterId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Menu whereEnd($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Menu whereFoodItems($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Menu whereStart($value)
